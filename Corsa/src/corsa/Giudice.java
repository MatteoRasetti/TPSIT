...
public class Giudice extends Thread{
    ...
    public void run(){
        Atleta a1 = new Atleta("Luigi",this.pista.icoAtleta1,this);                                       
        Atleta a2 = new Atleta("Mario",this.pista.icoAtleta2,this);
        Atleta a3 = new Atleta("Bowser",this.pista.icoAtleta3,this);
        a1.start();
        a2.start();
        a3.start();
       // this.via=true;
